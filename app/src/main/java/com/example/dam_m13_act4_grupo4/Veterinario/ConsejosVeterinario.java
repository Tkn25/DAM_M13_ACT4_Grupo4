...
public class ConsejosVeterinario extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        volver = findViewById(R.id.imageButton16);
        lista = findViewById(R.id.listaConsejosVet);
        nuevoConsejo = findViewById(R.id.button2);
        ...
        //En caso de pulsar el botón nuevoConsejo, se abrirá la actividad para insertar un nuevo consejo.
        nuevoConsejo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ConsejosVeterinario.this, InsertarConsejoVeterinario.class);
        ...
        volver.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ConsejosVeterinario.this, PrincipalVeterinario.class);
                startActivity(intent);
                finish();
            }
        });
